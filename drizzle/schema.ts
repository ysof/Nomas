...
export const products = mysqlTable("products", {
  ...
  category: varchar("category", { length: 100 }).notNull(), // "men", "women", "accessories"
...
/**
 * Cart items table for storing user shopping cart items.
 */
...
export const orders = mysqlTable("orders", {
  ...
  paymentMethod: varchar("paymentMethod", { length: 50 }).notNull(), // "cod" or "card"
